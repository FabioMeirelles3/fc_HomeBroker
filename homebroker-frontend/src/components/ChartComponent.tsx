...
import { AreaData, AreaSeries, IChartApi, ISeriesApi, Time, createChart } from "lightweight-charts";
import React, { Ref, useEffect, useImperativeHandle, useLayoutEffect, useRef } from "react";
...
export function ChartComponent(props: {
  ...
  return (
    <div className="flex-grow relative" ref={chartContainerRef}>
      <div className="absolute top-0 left-0 z-50 bg-gray-100 rounded-md p-2 shadow-md">{header}</div>
    </div>
  );
}
